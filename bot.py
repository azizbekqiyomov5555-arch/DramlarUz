...
def _add_watermark_ffmpeg(input_path: str, output_path: str, user_id: str, username: str = "") -> bool:
    ...
    try:
        ...
        # Yozuv video davomida qayta-qayta paydo bo'ladi va yo'qoladi.
        # Har qayta chiqqanda joyi o'zgaradi; x/y video chegarasidan chiqmaydi.
        # enable: har 3 soniyada 2.15 soniya ko'rinadi — qisqa videolarda ham boshidan chiqadi.
        x_expr = "(w-text_w)*(0.5+0.46*sin(t*1.37))"
        y_expr = "(h-text_h)*(0.5+0.43*cos(t*1.11))"
        enable_expr = "lt(mod(t\\,3.0)\\,2.15)"
