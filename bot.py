...
def _add_watermark_ffmpeg(input_path: str, output_path: str, user_id: str, username: str = "") -> bool:
    ...
    - Watermark HAR DOIM ko'rinadi (flicker yo'q) — barcha qismlarda chiqadi.
    - Video o'lchami (resolution) o'zgarmaydi.
    - Fayl hajmini ortib ketishini kamaytirish uchun CRF 28 ishlatiladi.
    """
    tmp_files = []
    try:
        ...
        # HAR DOIM ko'rinadigan 4 ta joylashuv: yuqori (chap+o'ng) va past (chap+o'ng)
        positions = [
            ("w*0.04",                  "h*0.04"),                  # yuqori-chap
            ("main_w-text_w-w*0.04",    "h*0.04"),                  # yuqori-o'ng
            ("w*0.04",                  "main_h-text_h-h*0.10"),    # past-chap
            ("main_w-text_w-w*0.04",    "main_h-text_h-h*0.10"),    # past-o'ng
        ]
...
async def sv_watermarked(bot, chat_id: int, file_id: str, caption: str,
    ...
    try:
        ...
        # ── 90 soniya timeout — uzunroq videolar uchun ham ulgursin ──
