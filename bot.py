...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # "Qo'llanma" tugmasi — Telegram Mini App sifatida ochiladi
    from telegram import WebAppInfo
    start_inline_rows.append([
        InlineKeyboardButton(
            text=bt("install"),
            web_app=WebAppInfo(url="https://azizbekqiyomov5555-arch.github.io/Kkk/")
        )
    ])
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "start_qollanma":
        # Eski fallback — Mini App inline button ishlamagan holat uchun
        from telegram import WebAppInfo
