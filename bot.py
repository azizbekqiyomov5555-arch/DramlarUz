...
# ── PTB v21+ uchun ExtBot subclass (monkey-patch o'rniga) ────
from telegram.ext import ExtBot as _ExtBot

class PatchedBot(_ExtBot):
    """HTML xabarlardagi emojilari premium emojiga aylantiradigan bot."""
    ...
    async def send_message(self, *args, **kwargs):
        if kwargs.get("parse_mode") == "HTML" and "text" in kwargs:
            ...
            args = list(args); args[1] = _e(args[1])
    ...
    async def edit_message_text(self, *args, **kwargs):
        if kwargs.get("parse_mode") == "HTML" and "text" in kwargs:
            ...
            args = list(args); args[0] = _e(args[0])
...
def main():
    ...
    logger.info("✅ PatchedBot ishga tushdi — barcha HTML xabarlarda premium emoji ishlaydi")
