...
def main():
    ...
    # ── ExtBot KLASSINI patch qilamiz (PTB v21 uchun to'g'ri usul) ──────
    # Instance patch ishlamaydi (__slots__) — klass metodini override qilamiz
    from telegram import Bot as _TGBot

    _orig_send      = _TGBot.send_message
    _orig_edit      = _TGBot.edit_message_text
    _orig_photo     = _TGBot.send_photo
    _orig_video     = _TGBot.send_video
    ...
    _TGBot.send_message      = _p_send
    _TGBot.edit_message_text = _p_edit
    _TGBot.send_photo        = _p_photo
    _TGBot.send_video        = _p_video
    logger.info("✅ Premium emoji patch qo'llandi (telegram.Bot klass darajasida, positional+keyword)")
