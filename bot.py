...
def main():
    ...
    import types
    app.bot.send_message      = _patched_send_message
    app.bot.edit_message_text = _patched_edit_message_text
    app.bot.send_photo        = _patched_send_photo
    app.bot.send_video        = _patched_send_video
