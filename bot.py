...
async def contact_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Pending start arg bo'lsa — qayta start chaqiramiz
...
async def admin_buttons(update, context, text: str):
    ...
    if _btn_match("auto_topup_stat"):
        ...
        msg = (
            ...
            f"💵 <b>Jami tushgan pul:</b> <b>{total:,} so'm</b>\n"
            f"🔢 <b>To'lovlar soni:</b> <b>{cnt:,} ta</b>\n"
            f"📊 <b>O'rtacha:</b> <b>{avg:,} so'm</b>\n\n"
        ...
        await sm(context.bot, uid, msg, admin_menu_kb(uid))
        return
