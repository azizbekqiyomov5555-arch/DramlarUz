...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "withdraw_confirm":
        ...
        # Yechish so'rovini ASOSIY (parent) bot adminiga yuboramiz —
        # bola botning lokal adminiga emas.
        try:
            await context.bot.send_message(PARENT_ADMIN_ID, adm_msg, parse_mode="HTML")
        except Exception as e:
            logger.error(f"withdraw notify parent admin failed: {e}")
        return
